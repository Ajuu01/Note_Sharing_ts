...
const SingleNote = async ({
  ...
  try {
    ...
    console.log("Single note result:", result);
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              ...
              />
              <div className="md:w-1/2 flex flex-col justify-center pointer-events-auto">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-4">{note.subtitle}</p>
              <p className="text-gray-700 leading-7">{note.description}</p>
            </div>
